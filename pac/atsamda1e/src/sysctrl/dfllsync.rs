...
#[doc = "Field `READREQ` reader - Read Request"]
pub struct READREQ_R(crate::FieldReader<bool, bool>);
impl READREQ_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        READREQ_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for READREQ_R {
...
impl R {
    ...
    pub fn readreq(&self) -> READREQ_R {
        READREQ_R::new(((self.bits >> 7) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 7 - Read Request"]
