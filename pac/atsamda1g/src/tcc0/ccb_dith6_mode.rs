#[doc = "Register `CCB_DITH6_MODE[%s]` reader"]
pub struct R(crate::R<CCB_DITH6_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CCB_DITH6_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CCB_DITH6_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CCB_DITH6_MODE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CCB_DITH6_MODE[%s]` writer"]
pub struct W(crate::W<CCB_DITH6_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CCB_DITH6_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CCB_DITH6_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CCB_DITH6_MODE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Compare and Capture Buffer\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ccb_dith6_mode](index.html) module"]
pub struct CCB_DITH6_MODE_SPEC;
impl crate::RegisterSpec for CCB_DITH6_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ccb_dith6_mode::R](R) reader structure"]
impl crate::Readable for CCB_DITH6_MODE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ccb_dith6_mode::W](W) writer structure"]
impl crate::Writable for CCB_DITH6_MODE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CCB_DITH6_MODE[%s]
to value 0"]
impl crate::Resettable for CCB_DITH6_MODE_SPEC {
    #[inline(always)]
