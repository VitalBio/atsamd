...
impl From<Startup> for u8 {
    fn from(startup: Startup) -> Self {
        match startup {
            Startup::CYCLE1 => 0x0,
            Startup::CYCLE32 => 0x1,
            Startup::CYCLE2048 => 0x2,
            Startup::CYCLE4096 => 0x3,
            Startup::CYCLE16384 => 0x4,
            Startup::CYCLE32768 => 0x5,
            Startup::CYCLE65536 => 0x6,
            Startup::CYCLE131072 => 0x7,
        }
    }
}
...
impl Xosc32k<ClockMode> {
    ...
    #[inline]
    pub fn from_clock(token: Xosc32kToken, xin32: impl Into<XIn32>) -> Self {
...
impl<M: Mode> Xosc32k<M> {
    #[inline]
    fn new(token: Xosc32kToken, xin32: XIn32, mode: M) -> Self {
        Self {
            token,
            xin32,
            mode,
    ...
    /// It also consumes and drops the [`Xosc32k`], which destroys API access
    /// to the registers.
    #[inline]
