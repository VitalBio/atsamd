...
impl DfllToken {
    ...
    #[inline]
    fn dfllctrl(&self) -> &crate::pac::sysctrl::DFLLCTRL {
        &self.sysctrl().dfllctrl
    }

    #[allow(dead_code)]
    #[inline]
    fn dfllval(&self) -> &crate::pac::sysctrl::DFLLVAL {
        &self.sysctrl().dfllval
    }

    #[inline]
    fn dfllmul(&self) -> &crate::pac::sysctrl::DFLLMUL {
        &self.sysctrl().dfllmul
    }

    #[allow(dead_code)]
    #[inline]
    fn dfllsync(&self) -> &crate::pac::sysctrl::DFLLSYNC {
        &self.sysctrl().dfllsync
    }

    #[inline]
    fn pclksr(&self) -> &crate::pac::sysctrl::PCLKSR {
        &self.sysctrl().pclksr
    }

    #[inline]
    fn wait_ready(&self) {
        while self.pclksr().read().dfllrdy().bit_is_clear() {}
    }

    #[inline]
    fn set_on_demand_mode(&mut self, value: bool) {
        self.dfllctrl().modify(|_, w| w.ondemand().bit(value));
    }

    #[inline]
    fn set_run_standby(&mut self, value: bool) {
        self.dfllctrl().modify(|_, w| w.runstdby().bit(value));
    }

    #[inline]
    fn enable(&mut self) {
        self.dfllctrl().modify(|_, w| w.enable().set_bit());
        self.wait_ready();
    }

    #[inline]
    fn disable(&mut self) {
        self.dfllctrl().modify(|_, w| w.enable().clear_bit());
        self.wait_ready();
    }
    ...
    fn set_mode(&mut self, mode: DynMode) {
        ...
        self.dfllctrl().modify(|_, w| w.mode().bit(bit));
        self.wait_ready();
    }

    #[inline]
    fn set_fine_max_step(&mut self, value: u16) {
        self.dfllmul()
