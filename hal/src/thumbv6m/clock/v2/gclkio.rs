...
impl GclkIo<Gclk0Id> for gpio::PA27 {}
    ...
    I: GclkIo<G>,
{
    ...
    #[inline]
    fn disable(self) -> (GclkInToken<G>, Pin<I, AlternateH>) {
        (self.token, self.pin)
    }
}
    ...
    I: GclkIo<G>,
{
    ...
    /// and `gpio` pin
    #[inline]
    pub fn disable(self) -> (GclkInToken<G>, Pin<I, AlternateH>) {
        self.0.disable()
    }
}
...
impl NotGclkInId for DpllId {}
impl NotGclkInId for Gclk1Id {}
impl NotGclkInId for OscUlp32kId {}
impl NotGclkInId for Osc32kId {}
impl NotGclkInId for Osc8mId {}
impl NotGclkInId for XoscId {}
